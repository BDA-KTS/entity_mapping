...
#with open("/data_ssd/linzbasn/raw_data/archived_collection.json", "r") as f:
#    objects = ijson.items(f, "item")  # assumes top-level is a list
#    for i, obj in enumerate(objects):
#        with open(f"/data_ssd/linzbasn/raw_data/{i}.json", "w") as f:
#            json.dump(obj, f)
